    ...
    constructor(userService) {
        ...
        this.initiateRegistration = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield this.userService.saveEncryptedData(userDetails, encryptedData);
                const callbackUrl = req.params.callbackUrl;
                const emailService = yield this.userService.createEmailService(userDetails, encryptedData, callbackUrl);
        ...
        this.completeRegistration = (req, res) => __awaiter(this, void 0, void 0, function* () {
            var _a, _b;
            try {
                const encryptedData = (_a = req.body) === null || _a === void 0 ? void 0 : _a.encryptedData;
                ...
                const requestBodyData = ((_b = req.body) === null || _b === void 0 ? void 0 : _b.data) || {};
